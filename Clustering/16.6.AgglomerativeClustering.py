...
if __name__ == '__main__':
    ...
    for index, (n_clusters, data, y) in enumerate(((4, data1, y1), (4, data1_noise, y1_noise),
        ...
        connectivity = kneighbors_graph(data, n_neighbors=7, mode='distance', metric='minkowski', p=2, include_self=True)  #欧氏距离，构造距离矩阵
        #print 'connectivity shape:',connectivity.shape
        connectivity = 0.5 * (connectivity + connectivity.T)
        #print 'connectivity shape2:', connectivity.shape
        for i, linkage in enumerate(linkages):   #linkages = ("ward", "complete", "average")
